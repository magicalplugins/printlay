...
// Filter presets live in a tiny standalone module so lightweight bundles (the
// embeddable widget) can import them without pulling in this whole component.
import { FILTER_PRESETS, filterCss, type FilterPreset } from "./filterPresets";

export { FILTER_PRESETS, filterCss, type FilterPreset };
